...
class ManoLayer(Module):
    ...
    def forward(self,
        ...
        # print(th_jtr.shape,th_results_global.shape)
        ...
        global_tsl = th_results_global[:, :, :3, 3:]  # (B, 16, 3, 1)
        # print(global_tsl.shape, center_joint.shape)
        ...
        skinning_blob = {
            "verts": th_verts, #*1000 to mm
            "joints": th_jtr,  #*1000 to mm
            "center_joint": center_joint,
            "transforms_abs": global_transf,
            "full_pose": th_full_pose
        }
